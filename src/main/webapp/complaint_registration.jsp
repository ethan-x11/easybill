...
<body>
    <div class="fullDiv">
        <div id="complaint_register" class="form-container">
            ...
            <br> <br>
            <form id="complaintForm" action="ComplaintRegistrationServlet" method="post" onsubmit="return registerComplaint()">
                <div class="form-grid">
                    <div class="form-group">
                        <label for="complaint_type">Complaint/Service Type:</label>
                        <select id="complaint_type" name="complaint_type" onchange="updateCategories()" required>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="contact_person" name="contact_person" placeholder="Enter Name" required><br> <br>
                    </div>
                    <div class="form-group">
                        <label for="consumer_no">Consumer No.:</label>
                        <input type="text" id="consumer_no" name="consumer_no" placeholder="Consumer No" minlength="13" maxlength="13" pattern="\d{13}" required><br> <br>
                    </div>
                    <div class="form-group">
                        <label for="mobile_no">Mobile No.:</label>
                        <input type="text" id="mobile_no" name="mobile_no" placeholder="Mobile No" minlength="10" maxlength="10" pattern="\d{10}" required><br> <br>
                    </div>
                    <div class="form-group">
                        <label for="complaint_date">Date:</label>
                        <input type="date" id="complaint_date" name="complaint_date" required><br> <br>
                    </div>
                    <div class="form-group textarea-group">
                        <label for="problem_description">Describe Your Problem:</label><br>
                        <textarea name="problem_description" id="problem_description" rows="5" cols="50" placeholder="Type your problem...." required></textarea><br> <br>
                    </div>
                    <div class="form-group">
                        <label for="address">Address:</label>
                        <textarea name="address" id="address" rows="3" cols="50" placeholder="Your Address" required></textarea><br> <br>
                    </div>
                    <div class="form-group">
                        <label for="landmark">Landmark:</label>
                        <input type="text" id="landmark" name="landmark" placeholder="Landmark" required><br> <br>
                    </div>
